...
#ifndef __DMA_M_SPI_H
#define __DMA_M_SPI_H
...
#define DMA_M_SPI_PRPH_BASE_ADDRESS  0x40008000U
  
/* Methods configuration constants - generated for all enabled component's methods */
#define DMA_M_SPI_Init_METHOD_ENABLED  /*!< Init method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_Deinit_METHOD_ENABLED /*!< Deinit method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_Enable_METHOD_ENABLED /*!< Enable method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_Disable_METHOD_ENABLED /*!< Disable method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_AllocateChannel_METHOD_ENABLED /*!< AllocateChannel method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_EnableChannel_METHOD_ENABLED /*!< EnableChannel method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_DisableChannel_METHOD_ENABLED /*!< DisableChannel method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_SetChannelSourceAddress_METHOD_ENABLED /*!< SetChannelSourceAddress method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_SetChannelDestinationAddress_METHOD_ENABLED /*!< SetChannelDestinationAddress method of the component DMA_M_SPI is enabled (generated) */
#define DMA_M_SPI_SetChannelByteCount_METHOD_ENABLED /*!< SetChannelByteCount method of the component DMA_M_SPI is enabled (generated) */

/* Number of DMA channels supported by hardware */
#define DMA_M_SPI_DMA_CHANNELS_NUMBER 0x04U
/* DMA doesn't support multiple multiplexers */
#define DMA_M_SPI_DMAMUX0_CHANNELS_NUMBER 0x00U
#define DMA_M_SPI_DMAMUX1_CHANNELS_NUMBER 0x00U
/* Number of configured channels (i.e. all channels set in DMA_M_SPI component) */
#define DMA_M_SPI_CONFIGURED_CHANNELS_NUMBER 0x02U
/* Number of available channels (i.e. all configured channels excluding permanently allocated channels) */
#define DMA_M_SPI_AVAILABLE_CHANNELS_NUMBER 0x02U
/* No DMAMUX0 channels configured */
#define DMA_M_SPI_CONFIGURED_DMAMUX0_CHANNELS_NUMBER 0x00U
/* No DMAMUX0 channels available */
#define DMA_M_SPI_AVAILABLE_DMAMUX0_CHANNELS_NUMBER 0x00U
/* No DMAMUX1 channels configured */
#define DMA_M_SPI_CONFIGURED_DMAMUX1_CHANNELS_NUMBER 0x00U
/* No DMAMUX1 channels available */
#define DMA_M_SPI_AVAILABLE_DMAMUX1_CHANNELS_NUMBER 0x00U
/* No permanently allocated channels */
#define DMA_M_SPI_ALLOCATED_CHANNELS_NUMBER 0x00U
/* No DMAMUX0 permanently allocated channels */
#define DMA_M_SPI_ALLOCATED_DMAMUX0_CHANNELS_NUMBER 0x00U
/* No DMAMUX1 permanently allocated channels */
#define DMA_M_SPI_ALLOCATED_DMAMUX1_CHANNELS_NUMBER 0x00U
/* Number of available channels capable of periodic triggering (excluding permanently allocated channels) */
#define DMA_M_SPI_PERIODIC_TRIGGER_CHANNELS_NUMBER 0x02U
/* No DMAMUX0 channels capable of periodic triggering available. */
#define DMA_M_SPI_PERIODIC_TRIGGER_DMAMUX0_CHANNELS_NUMBER 0U
/* No DMAMUX1 channels capable of periodic triggering available. */
#define DMA_M_SPI_PERIODIC_TRIGGER_DMAMUX1_CHANNELS_NUMBER 0U
/* No channels without periodic triggering capability available. */
#define DMA_M_SPI_SIMPLE_CHANNELS_NUMBER 0U
/* No DMAMUX0 channels without periodic triggering capability available. */
#define DMA_M_SPI_SIMPLE_DMAMUX0_CHANNELS_NUMBER 0U
/* No DMAMUX1 channels without periodic triggering capability available. */
#define DMA_M_SPI_SIMPLE_DMAMUX1_CHANNELS_NUMBER 0U
/* Channel number constants */
#define DMA_M_SPI_CHANNEL_0 0x00U
#define DMA_M_SPI_CHANNEL_1 0x01U
#define DMA_M_SPI_CHANNEL_2 0x02U
#define DMA_M_SPI_CHANNEL_3 0x03U
/*  This constant contains mask of all supported events */
#define DMA_M_SPI_AVAILABLE_EVENTS_MASK (LDD_DMA_ON_COMPLETE | LDD_DMA_ON_ERROR)
/* Maximum number of bytes to be transferred in each service request of the channel */
#define DMA_M_SPI_MAX_BYTE_COUNT 0x00FFFFFFU
typedef struct {
...
} DMA_M_SPI_TDescriptorRecord;         /* Transfer descriptor record type. */

typedef DMA_M_SPI_TDescriptorRecord *DMA_M_SPI_TDescriptorRecordPtr; /* Pointer to transfer descriptor record. */

typedef struct {
  bool EnUser;                         /* Enable/Disable device */
  DMA_M_SPI_TDescriptorRecord DescriptorRecord[DMA_M_SPI_CONFIGURED_CHANNELS_NUMBER]; /* Transfer descriptor records table, one record per one channel. */
  DMA_M_SPI_TDescriptorRecord *ChannelRecord[DMA_M_SPI_DMA_CHANNELS_NUMBER]; /* Channel record table for each channel. */
  LDD_TUserData *UserDataPtr;          /* User device data structure */
  LDD_TEventMask EventMask[DMA_M_SPI_DMA_CHANNELS_NUMBER]; /* Event mask of enabled events */
} DMA_M_SPI_TDeviceData;               /* Device data structure */

/* DMA Transfer descriptor structure variables external declarations */
extern DMA_M_SPI_TDeviceData *DMA_M_SPI_DeviceDataPtr;
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_SetClockConfiguration (component DMA_LDD)
**
**     Description :
...
** ===================================================================
*/
void DMA_M_SPI_SetClockConfiguration(LDD_TDeviceData *DeviceDataPtr, LDD_TClockConfiguration ClockConfiguration);
