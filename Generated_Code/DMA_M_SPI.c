...
**     Contents    :
**         Init                         - LDD_TDeviceData* DMA_M_SPI_Init(LDD_TUserData *UserDataPtr);
**         Deinit                       - void DMA_M_SPI_Deinit(LDD_TDeviceData *DeviceDataPtr);
**         Enable                       - LDD_TError DMA_M_SPI_Enable(LDD_TDeviceData *DeviceDataPtr);
**         Disable                      - LDD_TError DMA_M_SPI_Disable(LDD_TDeviceData *DeviceDataPtr);
**         AllocateChannel              - LDD_TError DMA_M_SPI_AllocateChannel(LDD_TDeviceData *DeviceDataPtr,...
**         EnableChannel                - LDD_TError DMA_M_SPI_EnableChannel(LDD_TDeviceData *DeviceDataPtr,...
**         DisableChannel               - LDD_TError DMA_M_SPI_DisableChannel(LDD_TDeviceData *DeviceDataPtr,...
**         SetChannelSourceAddress      - LDD_TError DMA_M_SPI_SetChannelSourceAddress(LDD_TDeviceData *DeviceDataPtr,...
**         SetChannelDestinationAddress - LDD_TError DMA_M_SPI_SetChannelDestinationAddress(LDD_TDeviceData...
**         SetChannelByteCount          - LDD_TError DMA_M_SPI_SetChannelByteCount(LDD_TDeviceData *DeviceDataPtr,...
**
...
*/         
/*!
**  @addtogroup DMA_M_SPI_module DMA_M_SPI module documentation
**  @{
*/         
...
static DMA_M_SPI_TDeviceData DeviceDataPtr__DEFAULT_RTOS_ALLOC;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static DMA_M_SPI_TDeviceData * INT_DMA0__DEFAULT_RTOS_ISRPARAM;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static DMA_M_SPI_TDeviceData * INT_DMA1__DEFAULT_RTOS_ISRPARAM;
/* Channel numbers initialization table */
static const LDD_DMA_TChannelNumber DMA_M_SPI_ChannelNumbers[DMA_M_SPI_CONFIGURED_CHANNELS_NUMBER] = {
  0x00U,
  0x01U
};
/* Channel interrupts enable initialization table */
static const bool DMA_M_SPI_ChannelInterrupts[DMA_M_SPI_CONFIGURED_CHANNELS_NUMBER] = {
  TRUE,
  TRUE
};

/* Internal method prototypes */
static bool GetRecord(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr, DMA_M_SPI_TDescriptorRecordPtr *DescriptorRecordAddressPtr);
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_Init (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TDeviceData* DMA_M_SPI_Init(LDD_TUserData *UserDataPtr)
{
  uint8_t i;
  DMA_M_SPI_TDeviceData *DeviceDataPtr; /* LDD device structure */
  DMA_M_SPI_TDescriptorRecord *DescriptorRecordPtr; /* Auxiliary local pointer to internal descriptor records. */
  ...
  for (i = 0U; i < DMA_M_SPI_DMA_CHANNELS_NUMBER; i++) {
  ...
  for(i = 0U; i < DMA_M_SPI_CONFIGURED_CHANNELS_NUMBER; i++) {
    DescriptorRecordPtr = &(DeviceDataPtr->DescriptorRecord[i]); /* Store local pointer to descriptor record. */
    DescriptorRecordPtr->ChannelNumber = DMA_M_SPI_ChannelNumbers[i]; /* Store associated channel number. */
    DescriptorRecordPtr->DescriptorPtr = NULL; /* Set channel as free. */
    DescriptorRecordPtr->Interrupts = DMA_M_SPI_ChannelInterrupts[i]; /* Store associated channel interrupts enabled/disabled status. */
    ...
    DeviceDataPtr->ChannelRecord[DMA_M_SPI_ChannelNumbers[i]] = DescriptorRecordPtr; /* Store pointers to descriptor records of fixed channels. */
    DeviceDataPtr->EventMask[DMA_M_SPI_ChannelNumbers[i]] = 0U; /* Clear channel event mask. */
  }
  DeviceDataPtr->EnUser = FALSE;       /* Set the flag "device disabled by user" */
  /* Registration of the device structure */
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_DMA_M_SPI_ID,DeviceDataPtr);
  return ((LDD_TDeviceData *)DeviceDataPtr); /* Return pointer to the data structure */
}

/*
** ===================================================================
**     Method      :  DMA_M_SPI_Deinit (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void DMA_M_SPI_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PE_LDD_UnregisterDeviceStructure(PE_LDD_COMPONENT_DMA_M_SPI_ID);
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_Enable (component DMA_LDD)
*/
/*!
**     @brief
**         Enables DMA device.
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_Enable(LDD_TDeviceData *DeviceDataPtr)
{
  ((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->EnUser = TRUE;
  return ERR_OK;
}

/*
** ===================================================================
**     Method      :  DMA_M_SPI_Disable (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_Disable(LDD_TDeviceData *DeviceDataPtr)
{
  ((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->EnUser = FALSE;
  return ERR_OK;
}

/*
** ===================================================================
**     Method      :  DMA_M_SPI_AllocateChannel (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_AllocateChannel(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr)
{
  DMA_M_SPI_TDeviceData *LocalDeviceDataPtr = (DMA_M_SPI_TDeviceData *)DeviceDataPtr; /* Auxiliary variable - pointer to an internal state structure */
  DMA_M_SPI_TDescriptorRecord *DescriptorRecordPtr; /* Auxiliary local pointer to internal descriptor records. */
  ...
  if (!((DMA_M_SPI_TDeviceData *)(DeviceDataPtr))->EnUser) { /* Is the device disabled by user? */
  ...
  if (!DescriptorPtr->ChannelAutoSelection) { /* Fixed channel wanted? */
    ...
    i = DMA_M_SPI_ALLOCATED_CHANNELS_NUMBER;
    while ((i < (DMA_M_SPI_ALLOCATED_CHANNELS_NUMBER + DMA_M_SPI_PERIODIC_TRIGGER_CHANNELS_NUMBER)) && (!ChannelFound)) {
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_EnableChannel (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_EnableChannel(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr)
{
  LDD_DMA_TChannelNumber ChannelNumber;
  DMA_M_SPI_TDescriptorRecord *DescriptorRecordPtr;
  ...
  if (!DescriptorRecordPtr->Initialized) { /* Is channel already initialized? */
    ...
    if (DescriptorPtr->Interrupts) {   /* Interrupts enabled? */
      ...
      if (DescriptorPtr->OnComplete) { /* Is transfer complete event enabled? */
        ((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->EventMask[ChannelNumber] |= LDD_DMA_ON_COMPLETE;
      }
      if (DescriptorPtr->OnError) {    /* Is transfer error event enabled? */
        ((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->EventMask[ChannelNumber] |= LDD_DMA_ON_ERROR;
      }
    }
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_DisableChannel (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_DisableChannel(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr)
{
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_SetChannelSourceAddress (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_SetChannelSourceAddress(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr, LDD_DMA_TAddress Address)
{
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_SetChannelDestinationAddress (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_SetChannelDestinationAddress(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr, LDD_DMA_TAddress Address)
{
  LDD_DMA_TAddress LocalAddress;
  LDD_DMA_TChannelNumber ChannelNumber;
...
/*
** ===================================================================
**     Method      :  DMA_M_SPI_SetChannelByteCount (component DMA_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
LDD_TError DMA_M_SPI_SetChannelByteCount(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr, LDD_DMA_TByteCount ByteCount)
{
  ...
  /* Transferred byte count range test - this test can be disabled by setting the "Ignore range checking"
     property to the "yes" value in the "Configuration inspector" */
  if (ByteCount > DMA_M_SPI_MAX_BYTE_COUNT) { /* Test if ByteCount is in correct range. */
    return ERR_PARAM_DATA;
  }   
  /* New transfer descriptor consistency test - this test can be disabled by setting the "Ignore range checking"
     property to the "yes" value in the "Configuration inspector" */
...
bool ChannelFound = FALSE;
  ...
  if (((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->ChannelRecord[DescriptorPtr->ChannelNumber]->DescriptorPtr == DescriptorPtr) {
    ChannelFound = TRUE;
...
static bool GetRecord(LDD_TDeviceData *DeviceDataPtr, LDD_DMA_TTransferDescriptor *DescriptorPtr, DMA_M_SPI_TDescriptorRecordPtr *DescriptorRecordAddressPtr)
{
  ...
  if (((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->ChannelRecord[DescriptorPtr->ChannelNumber]->DescriptorPtr == DescriptorPtr) {
    RecordFound = TRUE;
    *DescriptorRecordAddressPtr = ((DMA_M_SPI_TDeviceData *)DeviceDataPtr)->ChannelRecord[DescriptorPtr->ChannelNumber]; /* Save descriptors record address. */
  }
  return RecordFound;
}
...
** ===================================================================
*/
PE_ISR(DMA_M_SPI_Channel0Interrupt)
{
  /* {Default RTOS Adapter} ISR parameter is passed through the global variable */
  DMA_M_SPI_TDeviceData* DeviceDataPtr = INT_DMA0__DEFAULT_RTOS_ISRPARAM;
  if (DMA_PDD_GetChannelErrorFlags(DMA_BASE_PTR, DMA_M_SPI_CHANNEL_0) != 0x00U) {
    if (((DeviceDataPtr)->EventMask[DMA_M_SPI_CHANNEL_0] & LDD_DMA_ON_ERROR) != 0x00U) {
      DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_0]->DescriptorPtr->OnErrorEventPtr(DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_0]->DescriptorPtr->UserDataPtr);
    }
    DMA_PDD_ClearInterruptFlags(DMA_BASE_PTR, DMA_M_SPI_CHANNEL_0, DMA_PDD_TRANSFER_COMPLETE_FLAG);
  } else {
    DMA_PDD_ClearInterruptFlags(DMA_BASE_PTR, DMA_M_SPI_CHANNEL_0, DMA_PDD_TRANSFER_COMPLETE_FLAG);
    if (((DeviceDataPtr)->EventMask[DMA_M_SPI_CHANNEL_0] & LDD_DMA_ON_COMPLETE) != 0x00U) {
      DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_0]->DescriptorPtr->OnCompleteEventPtr(DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_0]->DescriptorPtr->UserDataPtr);
    }
  }
}
/*
...
** ===================================================================
*/
PE_ISR(DMA_M_SPI_Channel1Interrupt)
{
  /* {Default RTOS Adapter} ISR parameter is passed through the global variable */
  DMA_M_SPI_TDeviceData* DeviceDataPtr = INT_DMA1__DEFAULT_RTOS_ISRPARAM;
  if (DMA_PDD_GetChannelErrorFlags(DMA_BASE_PTR, DMA_M_SPI_CHANNEL_1) != 0x00U) {
    if (((DeviceDataPtr)->EventMask[DMA_M_SPI_CHANNEL_1] & LDD_DMA_ON_ERROR) != 0x00U) {
      DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_1]->DescriptorPtr->OnErrorEventPtr(DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_1]->DescriptorPtr->UserDataPtr);
    }
    DMA_PDD_ClearInterruptFlags(DMA_BASE_PTR, DMA_M_SPI_CHANNEL_1, DMA_PDD_TRANSFER_COMPLETE_FLAG);
  } else {
    DMA_PDD_ClearInterruptFlags(DMA_BASE_PTR, DMA_M_SPI_CHANNEL_1, DMA_PDD_TRANSFER_COMPLETE_FLAG);
    if (((DeviceDataPtr)->EventMask[DMA_M_SPI_CHANNEL_1] & LDD_DMA_ON_COMPLETE) != 0x00U) {
      DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_1]->DescriptorPtr->OnCompleteEventPtr(DeviceDataPtr->ChannelRecord[DMA_M_SPI_CHANNEL_1]->DescriptorPtr->UserDataPtr);
    }
  }
}
/* END DMA_M_SPI. */
