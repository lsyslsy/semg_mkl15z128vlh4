...
**            Receiver                                     : Enabled
**              RxD                                        : ADC0_DM1/ADC0_SE5a/PTE17/SPI0_SCK/UART2_RX/TPM_CLKIN1/LPTMR0_ALT3
**              RxD pin signal                             : UART2_RX
**            Transmitter                                  : Enabled
**              TxD                                        : ADC0_DP1/ADC0_SE1/PTE16/SPI0_PCS0/UART2_TX/TPM_CLKIN0
**              TxD pin signal                             : UART2_TX
**            Flow control                                 : None
**          Initialization                                 : 
...
**         Main - void IO2_Main(LDD_TDeviceData *DeviceDataPtr);
**
...
/*
** ===================================================================
**     Method      :  IO2_Init (component Serial_LDD)
*/
/*!
**     @brief
...
** ===================================================================
*/
static void InterruptRx(IO2_TDeviceDataPtr DeviceDataPrv)
{
...
** ===================================================================
*/
static void InterruptTx(IO2_TDeviceDataPtr DeviceDataPrv)
{
...
/*
** ===================================================================
**     Method      :  IO2_Main (component Serial_LDD)
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void IO2_Main(LDD_TDeviceData *DeviceDataPtr)
{
  IO2_TDeviceDataPtr DeviceDataPrv = (IO2_TDeviceDataPtr)DeviceDataPtr;
