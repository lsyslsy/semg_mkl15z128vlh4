...
*/         
  ...
  __attribute__ ((section (".vectortable"))) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&WaitTimer_Interrupt,    /* 0x26  0x00000098   2   ivINT_PIT                     used by PE */
    ...
    (tIsrFunc)&EINT_SYNC_INT_Interrupt, /* 0x2E  0x000000B8   2   ivINT_PORTA                   used by PE */
    (tIsrFunc)&EINT_NOT_DRDY_Interrupt /* 0x2F  0x000000BC   2   ivINT_PORTD                   used by PE */
    }
  };
